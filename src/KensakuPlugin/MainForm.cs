...
using KensakuPlugin.Properties;
...
namespace Tekidoni
{
	public partial class MainForm : Form
	{
		...
		private KensakuPlugin kensakuPlugin = null;
		internal KensakuPlugin KensakuPlugin
		{
		...
		{
			KensakuPlugin.SetAlive(!KensakuPlugin.IsAlive);
